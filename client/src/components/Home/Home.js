    ...
    return (
        ...
        <div className={style.container}>
            ...
            <div className={style.buttons}>
                ...
                <button onClick={handleGetAllCountries} className={style.btn}>Get all countries</button>
                <select name='alphabetical' onChange={(e) =>handleOrderAlph(e)} className={style.filter}>
                    <option>-Alphabetical order-</option>
                    <option value='upwardAlph'>Upward</option>
                    <option value='fallingAlph'>Falling</option>
                </select>
                <select name='population' onChange={(e) => handleOrderPop(e)} className={style.filter}>
                    <option>-Population order-</option>
                    <option value='upwardPop'>Upward</option>
                    <option value='fallingPop'>Falling</option>
                </select>
                <select name='continent' onChange={(e) => handleFilterByContinent(e)} className={style.filter}>
